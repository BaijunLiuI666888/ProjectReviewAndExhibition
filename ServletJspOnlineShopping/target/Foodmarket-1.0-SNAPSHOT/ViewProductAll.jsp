                    ...
                    <div class="container">
                        ...
                        <div class="nav-collapse">
                              <ul class="nav">
                                ...
                                <li class="active"><a href="ViewProductAll.jsp"><%=dataBundle.getString("index_product")%></a></li>
                             
                     
                          
                           
                            <form name="vinform" action="SearchResult.jsp" method ="post" class="navbar-search pull-left">
                                <input type="text" name="t1" onkeyup="sendInfo()" placeholder="<%=dataBundle.getString("index_searchbar")%>" class="search-query span2">
                                <span id="amit"> </span>

                            </form>
                         <li class=""><a href="Loggin.jsp"><%=dataBundle.getString("index_Login")%></a></li>
                            </ul>
                ...
                <div class="row">
                    <div id="sidebar" class="span3">
                        <div class="well well-small">
                            ...
                            <li><a href="CategoryProducts.jsp?pid=1"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_drinks")%></span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=2"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_sf")%></span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=3"><span class="icon-chevron-right"> <%=dataBundle.getString("categorybar_freshmeat")%></span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=5"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_vegetables")%></span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=6"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_ingredients")%></span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=4"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_riceflournoodle")%> & NOODLES</span></a></li>
                            <li><a href="CategoryProducts.jsp?pid=7"><span class="icon-chevron-right"><%=dataBundle.getString("categorybar_others")%></span></a></li>
