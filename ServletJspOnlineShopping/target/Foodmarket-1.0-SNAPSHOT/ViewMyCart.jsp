		  ...
		  <a data-target=".nav-collapse" data-toggle="collapse" class="btn btn-navbar">
			...
			<span class="icon-bar"></span>
			  ...
			  <li class=""><a href="LogedVCP.jsp"><%=dataBundle.getString("2bar_products")%></a></li>
                          <li class="active"><a href="ViewMyCart.jsp"><%=dataBundle.getString("2bar_mycart")%></a></li>
...
<div class="well well-small">
		<h1><%=dataBundle.getString("maincontent_title")%></h1>
	<hr class="soften"/>	
			
       
        <h1><%=dataBundle.getString("maincontent_detailedTitle")%></h1>
        <%
